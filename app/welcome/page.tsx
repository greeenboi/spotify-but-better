            ...
            return (
              <div className="space-y-6 mx-6 my-2">
                <div className="flex items-center space-x-3">
                  ...
                  <h2 className="text-2xl font-semibold">Choose Playlist Directory</h2>
                </div>
              ...
              <div className="space-y-6 mx-6 my-2">
                {name && 
                    <div className="flex items-center space-x-3">
                        ...
                        <TextMorph className='text-2xl font-semibold'>
                            {name}
                        </TextMorph>
                    </div>
                }
              ...
              <div className="space-y-6 mx-6 my-2">
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox 
                    ...
                    onCheckedChange={(checked) => setOptionalStep1(checked as boolean)}
                  />
      ...
      >
        {!showForm ? (
          ...
          <Card className="mx-auto w-full max-w-xl bg-background/40 backdrop-blur-xl border-neutral-200/20">
            ...
            <CardContent className="px-8 relative w-full" style={{ minHeight: '300px' }}>
              <motion.div
                key={step}
