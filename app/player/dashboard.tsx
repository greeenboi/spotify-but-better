        ...
        <ScrollArea className="h-[calc(100vh-8rem)]">
          <div className="p-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 mb-8">
              {[...Array(6)].map((_, i) => (
                <div key={i} className="bg-gray-800 p-4 rounded-lg hover:bg-gray-700 transition-all group">
                  <Image width="160" height="160" src={`/placeholder.png`} alt="Album cover" className="w-full mb-4 rounded-md" />
                  <h3 className="font-semibold mb-1 truncate">Album {i + 1}</h3>
                  <p className="text-sm text-gray-400 truncate">Artist {i + 1}</p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 mb-8">
              {[...Array(6)].map((_, i) => (
                <div key={i} className="bg-gray-800 p-4 rounded-lg hover:bg-gray-700 transition-all group">
                  <Image width="160" height="160" src={`/placeholder.png`} alt="Playlist cover" className="w-full mb-4 rounded-md" />
                  <h3 className="font-semibold mb-1 truncate">Daily Mix {i + 1}</h3>
                  <p className="text-sm text-gray-400 truncate">Your daily music mix</p>
                  <button className="mt-2 bg-green-500 text-black rounded-full p-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <Play className="h-4 w-4" />
                  </button>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {[...Array(4)].map((_, i) => (
                <div key={i} className="bg-gray-800 rounded flex items-center overflow-hidden hover:bg-gray-700 transition-all group">
                  <Image width="160" height="160" src={`/placeholder.svg?height=80&width=80`} alt="Playlist cover" className="h-20 w-20" />
                  <span className="font-semibold px-4 truncate">Top Playlist {i + 1}</span>
